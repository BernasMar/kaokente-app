...
def pagina_login_menu(df):
    ...
    with tab_registo:
        ...
        # REMOVIDO st.form para permitir que a Data de Nascimento atualize a página
        ...
        # Agora esta lógica funciona porque o st.date_input faz a página atualizar
